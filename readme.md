...
- O seu objetivo principal é transformar esse [mockup](./Layout/Preview.jpg) em um protótipo funcional usando [NextJS](https://nextjs.org/);
...
Em caso de dúvidas, [abra uma issue](https://github.com/dhiegopereira/frontend-challenge-1/issues).
